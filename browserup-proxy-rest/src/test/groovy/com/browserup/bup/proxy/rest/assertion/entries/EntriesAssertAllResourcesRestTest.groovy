...
class EntriesAssertAllResourcesRestTest extends BaseRestTest {
    def requestUrl = 'request-url'
    def responseBody = "success"

    @Override
    String getUrlPath() {
        return 'har/entries/assertResourceResponsesSuccessful'
    }

    @Test
    void noBrokenResourcesTestForImageMediaTypeAndStatusOk() {
        Header header = new Header("Content-Type", "image/png")
    ...
    @Test
    void noBrokenResourcesTestForJSMediaTypeAndStatusOk() {
        Header header = new Header("Content-Type", "text/javascript")
        sendRequestsToTargetServer(SC_OK, header)
    ...
    @Test
    void noBrokenResourcesTestForCSSMediaTypeAndStatusOk() {
        Header header = new Header("Content-Type", "text/css")
        sendRequestsToTargetServer(SC_OK, header)
    ...
    @Test
    void noBrokenResourcesTestForEmptyMediaTypeAndStatusOk() {
    ...
    @Test
    void noBrokenResourcesTestForExpectedMediaTypeAndStatusNotFound() {
