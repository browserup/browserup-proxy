    ...
    implements ComponentListener
{
    ...
    protected void defineManagedResource()
    {
        ...
        defineAttribute("listeners", ModelMBeanImpl.READ_ONLY);
        defineAttribute("contexts", ModelMBeanImpl.READ_ONLY);
        defineAttribute("version", ModelMBeanImpl.READ_ONLY, ModelMBeanImpl.ON_MBEAN);
        defineAttribute("components", ModelMBeanImpl.READ_ONLY, ModelMBeanImpl.ON_MBEAN);
        defineAttribute("requestLog");
        
        defineAttribute("trace");

        
        defineOperation("addListener",new String[]{"java.lang.String"}, ModelMBeanImpl.IMPACT_ACTION);
        defineOperation("addListener",new String[]{"net.lightbody.bmp.proxy.jetty.util.InetAddrPort"}, ModelMBeanImpl.IMPACT_ACTION);
        defineOperation("addListener",new String[]{"HttpListener"}, ModelMBeanImpl.IMPACT_ACTION);
        defineOperation("removeListener",new String[]{"HttpListener"}, ModelMBeanImpl.IMPACT_ACTION);
        defineOperation("addContext",new String[]{"HttpContext"}, ModelMBeanImpl.IMPACT_ACTION);
        defineOperation("removeContext",new String[]{"HttpContext"}, ModelMBeanImpl.IMPACT_ACTION);
        defineOperation("addContext",new String[]{"java.lang.String"}, ModelMBeanImpl.IMPACT_ACTION);
        defineOperation("addContext",new String[]{"java.lang.String","java.lang.String"}, ModelMBeanImpl.IMPACT_ACTION);
        ...
        defineOperation("save",new String[]{"java.lang.String"}, ModelMBeanImpl.IMPACT_ACTION);
        defineOperation("destroy", ModelMBeanImpl.IMPACT_ACTION);
    }
