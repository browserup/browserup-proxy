...
public class TagLibConfiguration implements Configuration
{
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see WebApplicationContext.Configuration#setWebApplicationContext(WebApplicationContext)
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see WebApplicationContext.Configuration#getWebApplicationContext()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see WebApplicationContext.Configuration#configureDefaults()
     */
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see WebApplicationContext.Configuration#configureWebApp()
     */
