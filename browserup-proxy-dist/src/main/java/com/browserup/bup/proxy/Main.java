...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (args.length > 0 && "--version".equals(args[0])) {
            System.out.println("BrowserUp Proxy " + BrowserUpProxyUtil.getVersionString());
            System.exit(0);
        }
    ...
    private static void configureLogging() {
        ...
        if (log4jFileLocation == null || log4jFileLocation.isEmpty()) {
            ...
            // the system property "basedir" is set to the location of the BrowserUp-proxy script or .bat file by the script itself.
            ...
            if (!Files.isReadable(logFilePath)) {
                ...
                if (!Files.isReadable(logFilePath)) {
                    ...
                    Path tempDir;
                    try {
                        tempDir = Files.createTempDirectory("BrowserUp-proxy");
                    } catch (IOException e) {
