                                    ...
                                    Serializable
{
    ...
    /* ------------------------------------------------------------ */
    public net.lightbody.bmp.proxy.jetty.http.Authenticator getAuthenticator()
    {
        return _authenticator;
    }

    /* ------------------------------------------------------------ */
    public void setAuthenticator(net.lightbody.bmp.proxy.jetty.http.Authenticator authenticator)
    {
