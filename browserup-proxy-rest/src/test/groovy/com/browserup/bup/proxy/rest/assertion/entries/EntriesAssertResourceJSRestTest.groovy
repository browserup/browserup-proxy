...
class EntriesAssertResourceJSRestTest extends BaseRestTest {
    def requestUrl = 'request-url'
    def responseBody = "success"

    @Override
    String getUrlPath() {
        return 'har/entries/assertJavaScriptResponsesSuccessful'
    }

    @Test
    void noBrokenJSTestForExpectedMediaTypeAndStatusOk() {
    ...
    @Test
    void noBrokenJSTestForEmptyMediaTypeAndStatusOk() {
    ...
    @Test
    void noBrokenJSTestForExpectedMediaTypeAndStatusNotFound() {
        Header header = new Header("Content-Type", "text/javascript")
