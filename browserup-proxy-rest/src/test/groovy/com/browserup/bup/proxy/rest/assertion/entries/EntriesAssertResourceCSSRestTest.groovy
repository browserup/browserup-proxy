...
class EntriesAssertResourceCSSRestTest extends BaseRestTest {
    def requestUrl = 'request-url'
    def responseBody = "success"

    @Override
    String getUrlPath() {
        return 'har/entries/assertStyleSheetResponsesSuccessful'
    }

    @Test
    void noBrokenCSSTestForExpectedMediaTypeAndStatusOk() {
    ...
    @Test
    void noBrokenCSSTestForEmptyMediaTypeAndStatusOk() {
    ...
    @Test
    void noBrokenCSSTestForExpectedMediaTypeAndStatusNotFound() {
        Header header = new Header("Content-Type", "text/css")
